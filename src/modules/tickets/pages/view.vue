...
import Attachments from "@/components/tickets/attachment.vue";
import Comments from "@/components/tickets/comment.vue";

import type { Ticket } from '@/components/tickets/columns'; 
import type { Attachment } from '@/components/tickets/attachment'; 
import type { Comment } from '@/components/tickets/comment'; 
...
const comments: Comment[] = [
  {
    id: 1,
    author: 'Jose Reyes',
    comment: 'Users are reporting that they\'re being locked out of their accounts after only 2 failed password attempts. The system should allow 5 attempts before locking. I\'ve documented several cases from this morning.',
    timestamp: new Date("2025-12-02T11:00:00"),
  },
  {
    id: 2,
    author: 'Juan Dela Cruz',
    comment: 'I\'ve investigated the issue and found a misconfiguration in the authentication module. The lockout threshold was set to 2 instead of 5. I\'m attaching the updated configuration file for review before deploying to production.',
    timestamp: new Date("2025-12-02T11:00:00"),
    attachment: [
      { filename: 'IMG_0004', size: '2 MB' }
    ]
  },
  {
    id: 3,
    author: 'Jose Reyes',
    comment: 'Excellent work! I\'ve tested the fix in staging and confirmed that users can now attempt password reset 5 times before being locked out. The reset email delivery is also working correctly. Attaching the full test results.',
    timestamp: new Date("2025-12-02T11:00:00"),
    attachment: [
      { filename: 'IMG_0005', size: '1.8 MB' }
    ]
  },
];
...
<template>
  <div class="w-full grid grid-cols-1 lg:grid-cols-2">
      ...
      <CardContent class="space-y-7 mt-1">
        <div class="space-y-1">
          ...
          <p class="leading-relaxed">
            I'm unable to log into my account and need help regaining access as soon as possible. 
            I think I either forgot my password, my credentials might have expired, or my account 
            got automatically locked after several failed login attempts. I'm ready to verify my 
            ...
            additional security measures like two-factor authentication to avoid this issue in the future.
          </p>
        </div>
    ...
    <div class="w-full p-5 space-y-4">
      <Collapsible v-model:open="isOpen" class="border rounded-lg shadow-sm p-5 space-y-2">
